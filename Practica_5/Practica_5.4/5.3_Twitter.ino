...
String serverPath = "https://api.openweathermap.org/data/2.5/weather?lat=23.3119&lon=-103.2857&appid=9fd2febaf1feb5af6f9c5ac102be7bf6&units=metric"; //El path que usaste en el web para la tem de la API - TODO el path con http 
// ThingSpeak 
uint32_t SECRET_CH_ID = 2481018; // Tu channel ID number de thingspeak 
const char *SECRET_WRITE_APIKEY = "1KS7SYIT7YCKPZDD"; // El API write de thingspeak 
void setup() 
{ 
Serial.begin(115200); 
dht.begin(); 
...
void sendDataToThingSpeak(){ 
    ...
    apiTemperature + "*C";
    ThingSpeak.setTwitterTweet("Vlac1730", tweet); // sustituir por el nombre de tu usuario de twitter
