...
#define TOKEN "BBUS-5VhE9mu4Pz5nZgErRsovop4ww0Riv8" // Ubidots TOKEN ID el mismo que usamos en clase lo sacan de Ubidtos
#define MQTT_CLIENT_NAME "128456AbCde" //ID del cliente, 8 a 12 chars alfanumericos (ASCII), debe ser random y unico dif a otros devices
#define VARIABLE_LABEL_temp "temperatura" // Variable Temperatura
#define VARIABLE_LABEL_hum "humedad" // Variable Humedad
#define DEVICE_LABEL "practica43" // Nombre del dispositivo a crear
